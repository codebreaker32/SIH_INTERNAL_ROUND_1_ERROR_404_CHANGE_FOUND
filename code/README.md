...
- **Fine-Tuned Chatbot**A fine-tuned chatbot using Gemini AI that provides personalized support for managing diabetes and tracking vital health metrics like insulin levels.
